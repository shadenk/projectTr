!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(e)
    : ((t =
        "undefined" != typeof globalThis ? globalThis : t || self).MapboxDraw =
        e());
})(this, function () {
  "use strict";
  var t = function (t, e) {
    ...
    if (l > 2) {
      for (s = 0; s < l; s++)
        s === l - 2
          ...
          (e = t[o]),
          (n = t[r]),
          (c += (u(t[a][0]) - u(e[0])) * Math.sin(u(n[1])));
  ...
  var c = {
    ...
    p = { POLYGON: "polygon", LINE: "line_string", POINT: "point" },
    f = {
      FEATURE: "Feature",
      POLYGON: "Polygon",
    ...
    v = { FEATURE: "feature", MIDPOINT: "midpoint", VERTEX: "vertex" },
    m = { ACTIVE: "true", INACTIVE: "false" },
    _ = [
      "scrollZoom",
      "boxZoom",
      "dragRotate",
  ...
  (I.prototype.add = function (t) {
    ...
    (I.prototype.delete = function (t) {
      return (
        !1 === this.has(t) ||
          (this._length--, delete this._items[t], delete this._nums[t]),
        this
      );
    }),
  ...
  var x = [v.FEATURE, v.MIDPOINT, v.VERTEX],
    M = {
  ...
  function N(t, e) {
    var n = M.click(t, null, e),
      o = { mouse: d.NONE };
    return (
      n[0] &&
        ((o.mouse = n[0].properties.active === m.ACTIVE ? d.MOVE : d.POINTER),
        (o.feature = n[0].properties.meta)),
      -1 !== e.events.currentModeName().indexOf("draw") && (o.mouse = d.ADD),
  ...
  function F(t, e, n) {
    ...
    return (
      ...
      A(t.point, e.point) < o && e.time - t.time < r
    );
  }
  var w = { exports: {} },
    R = (w.exports = function (t, e) {
      if ((e || (e = 16), void 0 === t && (t = 128), t <= 0)) return "0";
      for (
        var n = Math.log(Math.pow(2, t)) / Math.log(e), o = 2;
        n === 1 / 0;
        o *= 2
      )
        n = (Math.log(Math.pow(2, t / o)) / Math.log(e)) * o;
  ...
  ((V.prototype = Object.create(D.prototype)).isValid = function () {
    ...
    (V.prototype.removeCoordinate = function (t) {
      ...
      n &&
        (n.splice(e[1], 1), n.length < 3 && this.coordinates.splice(e[0], 1));
    }),
  ...
  var B = { MultiPoint: U, MultiLineString: j, MultiPolygon: V },
  ...
  ((J.prototype = Object.create(D.prototype))._coordinatesToFeatures =
    function (t) {
      var e = this,
    ...
    (z.prototype.setSelectedCoordinates = function (t) {
      ...
      this._ctx.store.setSelectedCoordinates(t),
        t.reduce(function (t, n) {
          return (
            void 0 === t[n.feature_id] &&
              ((t[n.feature_id] = !0),
              e._ctx.store.get(n.feature_id).changed()),
            t
          );
        }, {});
    }),
    ...
    (z.prototype.featuresAt = function (t, e, n) {
      if ((void 0 === n && (n = "click"), "click" !== n && "touch" !== n))
  ...
  function X() {
    ...
    if (
      ...
      i &&
        t.ctx.map
          .getSource(l.COLD)
          .setData({ type: f.FEATURE_COLLECTION, features: t.sources.cold }),
      t.ctx.map
        .getSource(l.HOT)
        .setData({ type: f.FEATURE_COLLECTION, features: t.sources.hot }),
      t._emitSelectionChange &&
        (t.ctx.map.fire(g.SELECTION_CHANGE, {
          ...
          points: t.getSelectedCoordinates().map(function (t) {
            return {
              type: f.FEATURE,
              properties: {},
              geometry: { type: f.POINT, coordinates: t.coordinates }
            };
          })
        }),
      ...
      (t._deletedFeaturesToEmit = []),
        t.ctx.map.fire(g.DELETE, { features: s });
    }
    function u() {
  ...
  function W(t, e) {
    ...
    t._selectedCoordinates.length === n.length ||
      e.silent ||
      (t._emitSelectionChange = !0),
  ...
  (Z.prototype.createRenderBatch = function () {
      ...
      return (
        ...
        H(t).forEach(function (t) {
          n._featureIds.has(t) &&
            ...
            e.silent ||
              (-1 === n._deletedFeaturesToEmit.indexOf(n._features[t]) &&
                n._deletedFeaturesToEmit.push(n._features[t])),
    ...
    (Z.prototype.select = function (t, e) {
      ...
      return (
        void 0 === e && (e = {}),
        H(t).forEach(function (t) {
          n._selectedFeatureIds.has(t) ||
            (n._selectedFeatureIds.add(t),
            n._changedFeatureIds.add(t),
            e.silent || (n._emitSelectionChange = !0));
        }),
        this
      );
    }),
    ...
    (Z.prototype.clearSelected = function (t) {
      return (
        void 0 === t && (t = {}),
        this.deselect(this._selectedFeatureIds.values(), { silent: t.silent }),
        this
      );
    }),
    ...
    (Z.prototype.setSelectedCoordinates = function (t) {
      return (
        (this._selectedCoordinates = t), (this._emitSelectionChange = !0), this
      );
    }),
    (Z.prototype.clearSelectedCoordinates = function () {
      return (
        (this._selectedCoordinates = []), (this._emitSelectionChange = !0), this
      );
    }),
    (Z.prototype.getSelectedIds = function () {
      ...
      r = {
          ...
          return (
            ...
            (e.events = (function (e) {
              var n = Object.keys(e.options.modes).reduce(function (t, n) {
                ...
                s = null;
              (i.drag = function (t, n) {
                n({ point: t.point, time: new Date().getTime() })
                  ? (e.ui.queueMapClasses({ mouse: d.DRAG }), s.drag(t))
                ...
                (i.mousemove = function (t) {
                  if (
                    ...
                    (void 0 !== t.originalEvent.buttons
                      ? t.originalEvent.buttons
                      : t.originalEvent.which)
                  )
                ...
                (i.mouseup = function (t) {
                  var n = N(t, e);
                  (t.featureTarget = n),
                    P(o, { point: t.point, time: new Date().getTime() })
                      ? s.click(t)
                      : s.mouseup(t);
                }),
                ...
                (i.touchmove = function (t) {
                  if (e.options.touchEnabled)
                    return s.touchmove(t), i.touchdrag(t);
                }),
                (i.touchend = function (t) {
                  if (
                    (t.originalEvent.preventDefault(), e.options.touchEnabled)
                  ) {
                    var n = M.touch(t, null, e)[0];
                    (t.featureTarget = n),
                      F(r, { time: new Date().getTime(), point: t.point })
                        ? s.tap(t)
                        : s.touchend(t);
                  }
                });
              ...
              function c(o, r, i) {
                ...
                var c = u(e, r);
                (s = t(c, e)),
                  i.silent || e.map.fire(g.MODE_CHANGE, { mode: o }),
                  e.store.setDirty(),
                  e.store.render();
              }
              (i.keydown = function (t) {
                (t.srcElement || t.target).classList.contains(
                  "mapboxgl-canvas"
                ) &&
                  ((8 !== t.keyCode && 46 !== t.keyCode) ||
                  !e.options.controls.trash
                    ? u(t.keyCode)
                      ? s.keydown(t)
                      : 49 === t.keyCode && e.options.controls.point
                      ? c(h.DRAW_POINT)
                      : 50 === t.keyCode && e.options.controls.line_string
                      ? c(h.DRAW_LINE_STRING)
                      : 51 === t.keyCode &&
                        e.options.controls.polygon &&
                        c(h.DRAW_POLYGON)
              ...
              return {
                ...
                addEventListeners: function () {
                  e.map.on("mousemove", i.mousemove),
                    ...
                    e.options.keybindings &&
                      (e.container.addEventListener("keydown", i.keydown),
                      e.container.addEventListener("keyup", i.keyup));
                },
                removeEventListeners: function () {
                  e.map.off("mousemove", i.mousemove),
                    ...
                    e.options.keybindings &&
                      (e.container.removeEventListener("keydown", i.keydown),
                      e.container.removeEventListener("keyup", i.keyup));
                },
                trash: function (t) {
                  s.trash(t);
                },
            ...
            (e.ui = (function (t) {
              ...
              function a() {
                ...
                if (t.container) {
                  ...
                  et.forEach(function (t) {
                    r[t] !== o[t] &&
                      (i.push(t + "-" + o[t]),
                      null !== r[t] && a.push(t + "-" + r[t]));
                  }),
                    i.length > 0 &&
                      (e = t.container.classList).remove.apply(e, i),
              ...
              function s(t, e) {
                ...
                return (
                  (o.className = c.CONTROL_BUTTON + " " + e.className),
              ...
              function l(t) {
                ...
                o &&
                  o &&
                  "trash" !== t &&
                  (o.classList.add(c.ACTIVE_BUTTON), (n = o));
              }
              return {
                setActiveButton: l,
                queueMapClasses: i,
                ...
                addButtons: function () {
                  ...
                  return (
                    (o.className = c.CONTROL_GROUP + " " + c.CONTROL_BASE),
                    n
                      ? (n[p.LINE] &&
                          (e[p.LINE] = s(p.LINE, {
                            container: o,
                        ...
                        n.combine_features &&
                          (e.combine_features = s("combineFeatures", {
                            container: o,
                        ...
                        n.uncombine_features &&
                          (e.uncombine_features = s("uncombineFeatures", {
                            container: o,
            ...
            (n = e.ui.addButtons()),
            e.options.boxSelect &&
              ((e.boxZoomInitial = i.boxZoom.isEnabled()),
              i.boxZoom.disable(),
              i.dragPan.disable(),
              i.dragPan.enable()),
            i.loaded()
        ...
        removeLayers: function () {
          e.options.styles.forEach(function (t) {
            ...
            e.map.getSource(l.COLD) && e.map.removeSource(l.COLD),
            e.map.getSource(l.HOT) && e.map.removeSource(l.HOT);
        }
      };
    return (e.setup = r), r;
  }
  ...
  function at(t) {
    return (
      ...
      t.featureTarget.properties.active === m.ACTIVE &&
      t.featureTarget.properties.meta === v.FEATURE
    );
  }
  function st(t) {
    return (
      !!t.featureTarget &&
      !!t.featureTarget.properties &&
      t.featureTarget.properties.active === m.INACTIVE &&
      t.featureTarget.properties.meta === v.FEATURE
    );
  }
  function ut(t) {
  ...
  function Et(t, e, n) {
    ...
    return (
      i === f.POINT
        ...
        : i === f.LINE_STRING
        ? c(a, n)
        : 0 === i.indexOf(f.MULTI_PREFIX) &&
          ((o = i.replace(f.MULTI_PREFIX, "")),
          a.forEach(function (n, r) {
            var i = {
              type: f.FEATURE,
              properties: t.properties,
              geometry: { type: o, coordinates: n }
            };
            u = u.concat(Et(i, e, r));
          })),
      u
    ...
    return (function t(a) {
      ...
      function d() {
        if ("object" == typeof l.node && null !== l.node) {
          (l.keys && l.node_ === l.node) || (l.keys = kt(l.node)),
      ...
      return (
        void 0 !== p && l.update && l.update(p),
        u.before && u.before.call(l, l.node),
        c
          ? ("object" != typeof l.node ||
              null === l.node ||
              l.circular ||
              (r.push(l),
              d(),
              jt(l.keys, function (e, r) {
                o.push(e), u.pre && u.pre.call(l, l.node[e], e);
                var i = t(l.node[e]);
                n && Vt.call(l.node, e) && (l.node[e] = i.node),
  ...
  function Qt(t, e) {
    ...
    t.forEach(function (t) {
      ...
      t.type === f.POINT
        ? (e = r(o))
        : t.type === f.LINE_STRING || t.type === f.MULTI_POINT
        ? (e = o.map(r))
        : t.type === f.POLYGON || t.type === f.MULTI_LINE_STRING
        ? (e = o.map(i))
        : t.type === f.MULTI_POLYGON &&
          (e = o.map(function (t) {
            return t.map(function (t) {
              return i(t);
            });
  ...
  var te = {
    ...
    stopExtendedInteractions: function (t) {
      t.boxSelectElement &&
        (t.boxSelectElement.parentNode &&
          t.boxSelectElement.parentNode.removeChild(t.boxSelectElement),
    ...
    onMouseMove: function (t, e) {
      return (
        ct(e) && t.dragMoving && this.fireUpdate(),
  ...
  (te.onTap = te.onClick =
    ...
    (te.clickOnFeature = function (t, e) {
      ...
      var o = dt(e),
        ...
        a = this.isSelected(i);
      if (!o && a && this.getFeature(i).type !== f.POINT)
        return this.changeMode(h.DIRECT_SELECT, { featureId: i });
      a && o
        ? (this.deselect(i),
          this.updateUIClasses({ mouse: d.POINTER }),
          1 === r.length && Tt.enable(this))
        : !a && o
        ? (this.select(i), this.updateUIClasses({ mouse: d.MOVE }))
        : a ||
          o ||
    ...
    (te.onMouseDown = function (t, e) {
      return at(e)
        ...
        : this.drawConfig.boxSelect && it(e)
    ...
    (te.whileBoxSelect = function (t, e) {
      (t.boxSelecting = !0),
        this.updateUIClasses({ mouse: d.ADD }),
        t.boxSelectElement ||
          ((t.boxSelectElement = document.createElement("div")),
          t.boxSelectElement.classList.add(c.BOX_SELECT),
          this.map.getContainer().appendChild(t.boxSelectElement));
      var n = mt(e.originalEvent, this.map.getContainer()),
      ...
      function (t, e) {
        ...
        if (t.dragMoving) this.fireUpdate();
          ...
          var o = [
              ...
              mt(e.originalEvent, this.map.getContainer())
            ],
    ...
    (te.toDisplayFeatures = function (t, e, n) {
      (e.properties.active = this.isSelected(e.properties.id)
        ...
        n(e),
        this.fireActionable(),
        e.properties.active === m.ACTIVE &&
          e.geometry.type !== f.POINT &&
          Et(e).forEach(n);
    }),
    (te.onTrash = function () {
    ...
    (te.onCombineFeatures = function () {
      ...
      if (!(0 === t.length || t.length < 2)) {
        for (
          var e = [], n = [], o = t[0].type.replace("Multi", ""), r = 0;
          r < t.length;
          r++
        ) {
          var i = t[r];
        ...
        if (n.length > 1) {
          ...
          this.addFeature(a),
            ...
            this.map.fire(g.COMBINE_FEATURES, {
    ...
    (te.onUncombineFeatures = function () {
      ...
      if (0 !== e.length) {
        for (
          ...
          r(i);
        n.length > 1 &&
          this.map.fire(g.UNCOMBINE_FEATURES, {
            createdFeatures: n,
            deletedFeatures: o
          }),
          this.fireActionable();
  ...
  var ee = rt(v.VERTEX),
    ...
    oe = {
      ...
      onVertex: function (t, e) {
        ...
        dt(e) || -1 !== o
          ? dt(e) && -1 === o && t.selectedCoordPaths.push(n.coord_path)
            ...
            r = Kt(
              o.map(function (t) {
                return {
                  type: f.FEATURE,
                  properties: {},
                  geometry: { type: f.POINT, coordinates: t }
                };
              }),
              n
            ),
      ...
      onSetup: function (t) {
        ...
        return (
          this.setSelectedCoordinates(
            this.pathsToCoordinates(e, o.selectedCoordPaths)
          ),
          this.setSelected(e),
          Tt.disable(this),
      ...
      toDisplayFeatures: function (t, e, n) {
        t.featureId === e.properties.id
          ...
          : ((e.properties.active = m.INACTIVE), n(e)),
      ...
      onMouseMove: function (t, e) {
        ...
        return (
          (n && i) || (o && !i)
            ? this.updateUIClasses({ mouse: d.MOVE })
            : this.updateUIClasses({ mouse: d.NONE }),
          (o || n || r) && t.dragMoving && this.fireUpdate(),
          this.stopDragging(t),
          !0
        );
      },
  ...
  (oe.onTouchStart = oe.onMouseDown =
    function (t, e) {
      return ee(e)
        ? this.onVertex(t, e)
        : at(e)
  ...
  (re.onSetup = function () {
    var t = this.newFeature({
      type: f.FEATURE,
      properties: {},
      geometry: { type: f.POINT, coordinates: [] }
    });
    return (
      this.addFeature(t),
      this.clearSelectedFeatures(),
      this.updateUIClasses({ mouse: d.ADD }),
      this.activateUIButton(p.POINT),
      this.setActionableState({ trash: !0 }),
      { point: t }
    );
  }),
    ...
    (re.onTap = re.onClick =
      function (t, e) {
        this.updateUIClasses({ mouse: d.MOVE }),
          ...
          this.map.fire(g.CREATE, { features: [t.point.toGeoJSON()] }),
          this.changeMode(h.SIMPLE_SELECT, { featureIds: [t.point.id] });
      }),
    ...
    (re.onTrash = re.stopDrawingAndRemove),
    (re.onKeyUp = function (t, e) {
  ...
  var ae = {
    onSetup: function () {
      var t = this.newFeature({
        type: f.FEATURE,
        properties: {},
        geometry: { type: f.POLYGON, coordinates: [[]] }
      });
      return (
        this.addFeature(t),
        this.clearSelectedFeatures(),
        Tt.disable(this),
        this.updateUIClasses({ mouse: d.ADD }),
        this.activateUIButton(p.POLYGON),
        this.setActionableState({ trash: !0 }),
    ...
    onMouseMove: function (t, e) {
      t.polygon.updateCoordinate(
        ...
        lt(e) && this.updateUIClasses({ mouse: d.POINTER });
    }
  };
  (ae.onTap = ae.onClick =
    function (t, e) {
    ...
    (ae.onKeyUp = function (t, e) {
      pt(e)
        ? (this.deleteFeature([t.polygon.id], { silent: !0 }),
          this.changeMode(h.SIMPLE_SELECT))
        : ft(e) &&
          this.changeMode(h.SIMPLE_SELECT, { featureIds: [t.polygon.id] });
    }),
    (ae.onStop = function (t) {
      this.updateUIClasses({ mouse: d.NONE }),
        ...
        void 0 !== this.getFeature(t.polygon.id) &&
          ...
          t.polygon.isValid()
            ? this.map.fire(g.CREATE, { features: [t.polygon.toGeoJSON()] })
            : (this.deleteFeature([t.polygon.id], { silent: !0 }),
              this.changeMode(h.SIMPLE_SELECT, {}, { silent: !0 })));
    }),
    (ae.toDisplayFeatures = function (t, e, n) {
      ...
      if (0 !== e.geometry.coordinates.length) {
        ...
        if (!(r < 3)) {
          if (
            ((e.properties.meta = v.FEATURE),
            n(_t(t.polygon.id, e.geometry.coordinates[0][0], "0.0", !1)),
            r > 3)
          ) {
  ...
  var se = {
    onSetup: function (t) {
      ...
      if (o) {
        ...
        if (e.coordinates[a][0] === i[0] && e.coordinates[a][1] === i[1])
          (n = a + 1), e.addCoordinate.apply(e, [n].concat(e.coordinates[a]));
        else {
          if (e.coordinates[0][0] !== i[0] || e.coordinates[0][1] !== i[1])
            throw new Error(
      ...
      return (
        ...
        Tt.disable(this),
        this.updateUIClasses({ mouse: d.ADD }),
        this.activateUIButton(p.LINE),
        this.setActionableState({ trash: !0 }),
        { line: e, currentVertexPosition: n, direction: r }
      );
    },
    clickAnywhere: function (t, e) {
      if (
        (t.currentVertexPosition > 0 &&
          ie(e, t.line.coordinates[t.currentVertexPosition - 1])) ||
  ...
  (se.onTap = se.onClick =
    ...
    (se.onKeyUp = function (t, e) {
      ft(e)
        ? this.changeMode(h.SIMPLE_SELECT, { featureIds: [t.line.id] })
        : pt(e) &&
    ...
    (se.onStop = function (t) {
      Tt.enable(this),
        ...
        void 0 !== this.getFeature(t.line.id) &&
          ...
          t.line.isValid()
            ? this.map.fire(g.CREATE, { features: [t.line.toGeoJSON()] })
            : (this.deleteFeature([t.line.id], { silent: !0 }),
              this.changeMode(h.SIMPLE_SELECT, {}, { silent: !0 })));
    }),
        ...
        n(
          _t(
            ...
            e.geometry.coordinates[
              "forward" === t.direction ? e.geometry.coordinates.length - 2 : 1
            ],
            "" +
              ("forward" === t.direction
                ? e.geometry.coordinates.length - 2
  ...
  function pe(t, e) {
    return t.map(function (t) {
      return t.source
        ? t
        : tt(t, { id: t.id + "." + e, source: "hot" === e ? l.HOT : l.COLD });
    });
  }
  var fe = { exports: {} };
  !(function (t, e) {
    ...
    var k,
      ...
      J = V.toString,
      z = B.hasOwnProperty,
      Y = (k = /[^.]+$/.exec((G && G.keys && G.keys.IE_PROTO) || ""))
        ? "Symbol(src)_1." + k
        : "",
      $ = B.toString,
      q = RegExp(
                ...
                (function (t, e, n, o, r, i) {
                  ...
                  for (; ++l < u; ) {
                    var g = t[(d = s[l])],
                      y = e[d];
                    if (o)
                      var v = a ? o(y, g, d, e, t, i) : o(g, y, d, t, e, i);
    ...
    function xt(t) {
      if (
        ((n = (e = t) && e.constructor),
        (o = ("function" == typeof n && n.prototype) || B),
        e !== o)
      )
        return nt(t);
      var e,
    ...
    function Mt(t, e, n, o, r, i) {
      ...
      for (i.set(t, e), i.set(e, t); ++l < s; ) {
        ...
        if (p) {
          if (
            !F(e, function (t, e) {
              if (((a = e), !p.has(a) && (f === t || r(f, t, n, o, i))))
                return p.push(e);
              var a;
            })
          ) {
    ...
    ((ot && Ft(new ot(new ArrayBuffer(1))) != b) ||
      (rt && Ft(new rt()) != l) ||
      (it && Ft(it.resolve()) != f) ||
      (at && Ft(new at()) != g) ||
      (st && Ft(new st()) != m)) &&
    ...
    me = function (t, e) {
        ...
        options: (t = (function (t) {
          ...
          return (
            ...
            !1 === t.displayControlsDefault
              ? (e.controls = tt(de, t.controls))
              : (e.controls = tt(le, t.controls)),
            ((e = tt(ce, e)).styles = pe(e.styles, "cold").concat(
              pe(e.styles, "hot")
            )),
            e
          );
      ...
      (e = (function (t, e) {
        return (
          ...
          (e.add = function (e) {
            var n = JSON.parse(JSON.stringify(It(e))).features.map(function (
              e
            ) {
              if (((e.id = e.id || k()), null === e.geometry))
              ...
              if (
                ...
                if (void 0 === n)
                  throw new Error(
                    "Invalid geometry type: " + e.geometry.type + "."
                  );
                var o = new n(t, e);
                t.store.add(o);
              } else {
                ...
                (r.properties = e.properties),
                  he(r.properties, e.properties) ||
                    t.store.featureChanged(r.id),
                  he(r.getCoordinates(), e.geometry.coordinates) ||
                    r.incomingCoords(e.geometry.coordinates);
              }
              return e.id;
            });
          ...
          (e.delete = function (n) {
            return (
              t.store.delete(n, { silent: !0 }),
              e.getMode() !== h.DIRECT_SELECT || t.store.getSelectedIds().length
                ? t.store.render()
                : t.events.changeMode(h.SIMPLE_SELECT, void 0, { silent: !0 }),
              e
            );
          }),
          ...
          (e.changeMode = function (n, o) {
            return (
              void 0 === o && (o = {}),
              n === h.SIMPLE_SELECT && e.getMode() === h.SIMPLE_SELECT
                ? (ge(o.featureIds || [], t.store.getSelectedIds()) ||
                    (t.store.setSelected(o.featureIds, { silent: !0 }),
                    t.store.render()),
                  e)
                : ((n === h.DIRECT_SELECT &&
                    e.getMode() === h.DIRECT_SELECT &&
                    o.featureId === t.store.getSelectedIds()[0]) ||
                    t.events.changeMode(n, o, { silent: !0 }),
                  e)
            );
          }),
          (e.getMode = function () {
